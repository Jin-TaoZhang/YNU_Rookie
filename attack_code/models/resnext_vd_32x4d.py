    ...
    def net(self, input, class_dim=1000):
        ...
        for block in range(len(depth)):
            for i in range(depth[block]):
                if layers in [101, 152, 200] and block == 2:
                    if i == 0:
                        conv_name = "vd_32_res" + str(block + 2) + "a"
                    else:
                        conv_name = "vd_32_res" + str(block + 2) + "b" + str(i)
                else:
                    conv_name = "vd_32_res" + str(block + 2) + chr(97 + i)
        ...
        out = fluid.layers.fc(
            ...
            param_attr=fluid.param_attr.ParamAttr(
                ...
                name='vd_32_fc_weights'),
            bias_attr=fluid.param_attr.ParamAttr(name='vd_32_fc_offset'))
