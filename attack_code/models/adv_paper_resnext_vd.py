...
__all__ = [
    "ResNeXt", "adv_paper_ResNeXt50_vd_64x4d", "ResNeXt101_vd_64x4d",
...
class ResNeXt():
    ...
    def net(self, input, class_dim=1000):
        ...
        for block in range(len(depth)):
            for i in range(depth[block]):
                if layers in [101, 152, 200] and block == 2:
                    if i == 0:
                        conv_name = "adv_paper_vd_res" + str(block + 2) + "a"
                    else:
                        conv_name = "adv_paper_vd_res" + str(block + 2) + "b" + str(i)
                else:
                    conv_name = "adv_paper_vd_res" + str(block + 2) + chr(97 + i)
        ...
        out = fluid.layers.fc(
            ...
            param_attr=fluid.param_attr.ParamAttr(
                ...
                name='adv_paper_vd_fc_weights'),
            bias_attr=fluid.param_attr.ParamAttr(name='adv_paper_vd_fc_offset'))
    ...
    def conv_bn_layer(self,
        ...
        if name == "conv1":
            ...
            bn_name = "adv_paper_vd_bn" + name[16:]
...
def adv_paper_ResNeXt50_vd_64x4d():
