...
__all__ = ["VGGNet", "VGG11", "VGG13", "VGG16", "adv_VGG19"]
...
class VGGNet():
    ...
    def net(self, input, class_dim=1000):
        ...
        conv1 = self.conv_block(input, 64, nums[0], name="adv_conv1_")
        conv2 = self.conv_block(conv1, 128, nums[1], name="adv_conv2_")
        conv3 = self.conv_block(conv2, 256, nums[2], name="adv_conv3_")
        conv4 = self.conv_block(conv3, 512, nums[3], name="adv_conv4_")
        conv5 = self.conv_block(conv4, 512, nums[4], name="adv_conv5_")

        fc_dim = 4096
        fc_name = ["adv_fc6", "adv_fc7", "adv_fc8"]
        fc1 = fluid.layers.fc(
            input=conv5,
            size=fc_dim,
            act='relu',
